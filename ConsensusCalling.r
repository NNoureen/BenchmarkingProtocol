...
Case1 = Data[which((Data$ES_AUCell >= 1 & Data$ES_SCSE >= 1 & Data$ES_JAS_NM < 1)),]
...
Case2 = Data[which((Data$ES_AUCell >= 1 & Data$ES_JAS_NM >= 1 & Data$ES_SCSE < 1)),]
...
Case3 = Data[which((Data$ES_SCSE >= 1 & Data$ES_JAS_NM >= 1 & Data$ES_AUCell < 1)),]
...
Case4 = Data[which((Data$ES_AUCell <= -1 & Data$ES_SCSE <= -1 & Data$ES_JAS_NM > -1)),]
...
Case5 = Data[which((Data$ES_AUCell <= -1 & Data$ES_JAS_NM <= -1 & Data$ES_SCSE > -1)),]

subsetcommon = data.frame(nrow(Case5),'AUCell vs JAS','Neg')
colnames(subsetcommon) = c('Common','Methods','ESDir')
CommonCases = rbind(CommonCases,subsetcommon)

Case6 = Data[which((Data$ES_SCSE <= -1 & Data$ES_JAS_NM <= -1 & Data$ES_AUCell > -1)),]
...
Case7 = Data[which(Data$ES_AUCell >= 1 & Data$ES_SCSE < 1 & Data$ES_JAS_NM < 1),]
subsetcommon = data.frame(nrow(Case7),'AUCell','Pos')
colnames(subsetcommon) = c('Common','Methods','ESDir')
CommonCases = rbind(CommonCases,subsetcommon)

Case8 = Data[which(Data$ES_SCSE >= 1 & Data$ES_JAS_NM < 1 & Data$ES_AUCell < 1),]
...
Case9 = Data[which(Data$ES_JAS_NM >= 1 & Data$ES_SCSE < 1 & Data$ES_AUCell < 1),]
...
Case10 = Data[which(Data$ES_AUCell <= -1 & Data$ES_SCSE > -1 & Data$ES_JAS_NM > -1),]
subsetcommon = data.frame(nrow(Case10),'AUCell','Neg')
colnames(subsetcommon) = c('Common','Methods','ESDir')
CommonCases = rbind(CommonCases,subsetcommon)


Case11 = Data[which(Data$ES_SCSE <= -1 & Data$ES_JAS_NM > -1 & Data$ES_AUCell > -1),]
subsetcommon = data.frame(nrow(Case11),'SCSE','Neg')
colnames(subsetcommon) = c('Common','Methods','ESDir')
CommonCases = rbind(CommonCases,subsetcommon)


Case12 = Data[which(Data$ES_JAS_NM <= -1 & Data$ES_SCSE > -1 & Data$ES_AUCell > -1),]
subsetcommon = data.frame(nrow(Case12),'JAS','Neg')
colnames(subsetcommon) = c('Common','Methods','ESDir')
CommonCases = rbind(CommonCases,subsetcommon)


Case13 = Data[which(Data$ES_JAS_NM >= 1 & Data$ES_SCSE >= 1 & Data$ES_AUCell >= 1),]
subsetcommon = data.frame(nrow(Case13),'AUCell & SCSE & AUCell','Pos')
colnames(subsetcommon) = c('Common','Methods','ESDir')
CommonCases = rbind(CommonCases,subsetcommon)

Case14 = Data[which(Data$ES_JAS_NM <= -1 & Data$ES_SCSE <= -1 & Data$ES_AUCell <= -1),]
